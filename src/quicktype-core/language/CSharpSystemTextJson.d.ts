...
export declare const cSharpOptions: {
    ...
    version: EnumOption<import("./CSharp").Version>;
    virtual: BooleanOption;
    typeForAny: EnumOption<import("./CSharp").CSharpTypeForAny>;
...
export declare class SystemTextJsonCSharpTargetLanguage extends CSharpTargetLanguage {
    constructor();
    protected getOptions(): Option<any>[];
    protected makeRenderer(renderContext: RenderContext, untypedOptionValues: {
        [name: string]: any;
